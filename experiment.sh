...
participate_client_ratio_list="*0.2"
non_iid_list="0.1"
epoch_list="5"
seed_list="0"
...
num_filters="64"
lr_rates="0.01"
activations="none tanh simple_tanh relu leaky_relu gelu swish mish"
num_aggregations="200"
                            ...
                            for activation in $activations; do
                                for aggregation_step in $num_aggregations; do
                                    python main_best.py --device 'cuda:0' --seed $seed \
                                                        ...
                                                        --model-kwargs num_filter=$filter_size,activation=$activation
                                done
                            done
                        done
                    done
