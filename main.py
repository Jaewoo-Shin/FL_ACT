...
MODEL = {'lenet': LeNet, 'lenetcontainer': LeNetContainer, 'vgg11': vgg11,
         ...
         'resnet8': resnet8, 'simpleNet3': simpleNet3, 'simpleNet4': simpleNet4, 'simpleNet5': simpleNet5, 'simpleNet6': simpleNet6, 'simpleNet7': simpleNet7,}
...
if __name__ == '__main__':
    ...
    for r in tqdm(range(args.num_rounds)):
        ...
        if r % 10 == 9:
            torch.save(, check_filename+f'epoch={r+1}')
    ...
    client_acc = personalized_accuracy(model, server_weight, dataset_sizes, client_loader, class_num, args)
