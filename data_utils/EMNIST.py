...
__all__ = ['load_partition_data_federated_emnist']
...
def load_partition_data_federated_emnist(data_dir, batch_size=DEFAULT_BATCH_SIZE):
    ...
    for client_idx in range(DEFAULT_TRAIN_CLIENTS_NUM):
        train_data_local, test_data_local = get_dataloader(data_dir, batch_size, batch_size, client_idx)
